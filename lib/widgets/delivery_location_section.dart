...
class DeliveryLocationSection extends StatefulWidget {
  ...
  @override
  State<DeliveryLocationSection> createState() => _DeliveryLocationSectionState();
}
      ...
      child: ClipRRect(
        ...
        child: Stack(
          children: [
            ...
            // Error overlay
            if (_errorMessage != null && !_isLoadingLocation) _buildErrorOverlay(),
            
            // Location info overlay
            if (!_isLoadingLocation && _errorMessage == null) _buildLocationInfo(),
